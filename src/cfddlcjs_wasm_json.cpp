...
std::string CallJsonApi(const std::string& command, const std::string& param) {
  ...
  // using cfd::dlc::js::api::json::g_callback_map;
  // using cfd::dlc::js::api::json::g_response_map;
  std::string result;
  try {
...
EMSCRIPTEN_KEEPALIVE extern "C" char* cfdjsJsonApi(
  ...
  using cfd::dlc::js::api::json::CallJsonApi;
  using cfd::dlc::js::api::json::CreateString;
  std::string cmd;
  std::string arg;
...
EMSCRIPTEN_KEEPALIVE extern "C" char* cfdjsGetJsonApiNames() {
  using cfd::dlc::js::api::json::CreateString;
  using cfd::dlc::js::api::json::GetJsonApiNames;
